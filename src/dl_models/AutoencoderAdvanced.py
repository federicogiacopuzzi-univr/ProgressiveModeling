...
def create_autoencoder_model(input_dim, latent_dim):
    ...
    # Encoder
    model.add(layers.Dense(256, input_dim=input_dim, activation='linear'))  # Encoder layer 1
    model.add(layers.Dense(128, activation='linear'))  # Encoder layer 2
    model.add(layers.Dense(64, activation='linear'))  # Encoder layer 3
    ...
    model.add(layers.Dense(128, activation='linear'))  # Decoder layer 2
    model.add(layers.Dense(256, activation='linear'))  # Decoder layer 3
