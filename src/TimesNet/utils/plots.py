...
def scatter_predictions(real, pred, target_name, filename, percent=False):
    ...
    plt.tight_layout()
    plt.savefig(filename if filename.endswith(".png") else filename + ".png", dpi=300, bbox_inches='tight')
    plt.close(fig)
